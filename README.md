...
- To clear everything, delete the text in the **textarea**, which will then automatically refresh with volume/octave set, but nothing else. To produce a sound, you need to select a track and set at least one of the envelope settings: `ea`, `es`, `er`.
