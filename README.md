...
- Long-press the **waveform** visualizer to export html/wav: the html file for your game and the wav file for whatever. It will export whatever is selected: ranges or whole song.
